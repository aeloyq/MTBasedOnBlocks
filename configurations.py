...
def get_config_en2zh():
    ...
    config['saveto'] = 'search_model_en2zh'
    ...
    config['src_vocab'] = datadir + 'vocab.en-zh.en.pkl'
    config['trg_vocab'] = datadir + 'vocab.en-zh.zh.pkl'

    # Source and target datasets
    config['src_data'] = datadir + 'en.en.tok.shuf'
    config['trg_data'] = datadir + 'zh.zh.tok.shuf'

    # Source and target vocabulary sizes, should include bos, eos, unk tokens
    config['src_vocab_size'] = 200000
    config['trg_vocab_size'] = 6540
    ...
    config['val_set'] = datadir + 'entest.en.tok'
    
    #config['test_set'] = datadir + 'test.en.tok'

    # Validation set gold file
    config['val_set_grndtruth'] = datadir + 'zhtest.zh.tok'
